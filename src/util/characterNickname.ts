export const characterNicknameList: Record<string, string[]> = {
  ...
  10000007: ['旅行者', 'traveller', 'lvxingzhe', 'lxz', 'kong', 'ying', '空', '荧', '爷', '老娘', '主角', '主人翁', '冒险者', '龙哥'],
  ...
  10000030: ['钟离', 'zhongli', '往生堂客卿', '钟师傅', '岩神', '摩拉克斯', '钟大爷'],
  10000031: ['菲谢尔', 'fischl', 'feixieer', '大幻梦森罗万象狂气断罪眼', '皇女', '中二皇女'],
  10000032: ['班尼特', 'bennett', 'bannite', '倒霉蛋', '点赞哥', '命运试金石'],
  10000033: ['达达利亚', 'tartaglia', 'dadaliya', 'ddly', '公子', '钱包', '达达利鸭', '达达鸭'],
  ...
  10000042: ['刻晴', 'keqing', '刻师傅', '斩尽牛杂', '玉衡星', '屁斜剑法', '免疫'],
